class Organization < ActiveRecord::Base
  ...
  :conversions, :customers, :default_codes, :documents, :employees, :imports, :ink_codes, 
  :import_bank_files, :import_bank_file_rows, :inventories, :items, :ledgers, :ledger_accounts, 
