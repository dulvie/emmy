...
class Organization < ActiveRecord::Base
  ...
  [:accounting_classes, :accounting_groups, :accounting_periods, :accounting_plans, :accounts,
   ...
   :ledger_transactions, :manuals, :materials, :ne_codes, :opening_balances, :opening_balance_items, :productions,
   :purchases, :purchase_items, :result_units, :shelves, :sales, :sale_items, :sie_exports, :sie_imports,
   :stock_values, :sie_transactions, :stock_value_items, :suppliers, :table_transactions, :tax_codes, :tax_returns,
