class Organization < ActiveRecord::Base
  ...
  :balance_transactions, :batches, :batch_transactions, :closing_balances, :code_transactions,
  :comments, :contact_relations, :contacts, :conversions, :customers, :default_codes, :documents,
  :employees, :export_bank_files, :export_bank_file_rows, :imports, :ink_codes, :import_bank_files,
  ...
  :purchases, :purchase_items, :result_units, :shelves, :sales, :sale_items, :stock_values,
