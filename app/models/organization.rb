class Organization < ActiveRecord::Base
  ...
  :batches, :batch_transactions, :closing_balances, :code_transactions, :comments, :contact_relations,
  :contacts, :conversions, :customers, :default_codes, :documents, :employees, :export_bank_files,
  ...
  :result_units, :shelves, :sales, :sale_items, :stock_values, :stock_value_items, :suppliers, 
  :tax_codes, :tax_returns, :tax_return_reports, :tax_tables, :tax_table_rows, :templates, 
  :template_items, :transfers, :units, :vat_periods, :vat_reports, :vats, :verificates, 
