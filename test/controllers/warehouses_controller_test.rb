...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { address: @warehouse.address, city: @warehouse.city, name: @warehouse.name, zip: @warehouse.zip }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { address: @warehouse.address, city: @warehouse.city, name: @warehouse.name, zip: @warehouse.zip }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
